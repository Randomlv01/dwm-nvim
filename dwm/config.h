...
static const char *fonts[]          = { "jetbrainsmonomono:size=12", "Hack Nerd Font Mono:size=16", "NotoColorEmoji:pixelsize=14:antialias=true:autohint=true"  };

static char normbgcolor[]           = "#3b4252"; // Hintergrundfarbe für normale Fenster
static char normbordercolor[]       = "#4c566a"; // Rahmenfarbe für normale Fenster
static char normfgcolor[]           = "#d8dee9"; // Textfarbe für normale Fenster
static char selfgcolor[]            = "#3b4252"; // Textfarbe für ausgewählte Fenster
static char selbordercolor[]        = "#88c0d0"; // Rahmenfarbe für ausgewählte Fenster
static char selbgcolor[]            = "#81a1c1"; // Hintergrundfarbe für ausgewählte Fenster

static char *colors[][3] = {
       /*               fg           bg           border   */
                [SchemeNorm] = { normfgcolor, normbgcolor, normbordercolor },
                [SchemeSel]  = { selbgcolor,  selfgcolor,  selbordercolor  },
                /* für die Statusleiste --> {text, hintergrund, null} */
                [SchemeStatus]  = { normfgcolor, normbgcolor,  normbgcolor  }, /* Status R */
                [SchemeTagsSel]  = { normfgcolor, normbgcolor,  normbgcolor  }, /* Tag L ausgewählt */
                [SchemeTagsNorm]  = { selbordercolor, normbgcolor,  normbgcolor  }, /* Tag L nicht ausgewählt */
                [SchemeInfoSel]  = { normfgcolor, normbgcolor,  normbgcolor  }, /* Info M ausgewählt */
                [SchemeInfoNorm]  = { normfgcolor, normbgcolor,  normbgcolor  }, /* Info M nicht ausgewählt */
};
